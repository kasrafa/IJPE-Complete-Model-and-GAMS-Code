...
* Standalone computational model.
* Model inputs and optimization logic are self-contained.

$offlisting
$offsymxref
$offsymlist

option limrow=0, limcol=0, solprint=off, sysout=off, decimals=6;
Sets
    ...
    q       raw scenario fields
            / demD1, demD2, demD3, trSP, trSC, cIron, cOther /
...
Table scenarioData(n,q) reduced scenario input
          demD1      demD2     demD3      trSP    trSC     cIron    cOther
    n1    27199.410  4720.048  1285.1843  21.005  14.1802  100.3281 42.8511
;
...
* Scientific results are displayed in the listing and written to generic files.
...
File paretoCsv / pareto_points.csv /;
put paretoCsv;
...
File paretoDecisionCsv / pareto_decisions.csv /;
...
File payoffCsv / payoff_table.csv /;
put payoffCsv;
...
File summaryCsv / solution_summary.csv /;
put summaryCsv;
put 'metric,value' /;
...
File flowCsv / solution_flows.csv /;
put flowCsv;
